...
ise_resource_group = "ise-tf-test"                           # Enter the Azure Resource Group name
...
vnet_name          = "isetestvnet"                           # Enter the Virtual Network name
ise_vm_subnet_name = "ps-prod-snet-app2"                     # Enter the Subnet name for Virtual Machine deployment 
...
ise_lb_subnet_name = "ps-prod-snet-app1"                     # Enter the Subnet name for Internal Loadbalancer deployment 
